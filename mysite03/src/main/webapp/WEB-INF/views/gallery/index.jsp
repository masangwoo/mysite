            ...
            <ul>
               <c:forEach var="item" items="${list}" varStatus="status">
                  <li><a href="${pageContext.request.contextPath }${item.url }"
                     data-lightbox="gallery" data-title="${item.comments}"
                     class="image"
                     style="background-image:url('${pageContext.request.contextPath }${item.url }')"></a>
                     <c:if test='${authUser.role=="ADMIN"}'>
                        <a
                           href="${pageContext.request.contextPath }/gallery/delete/${item.no}"
